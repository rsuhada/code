...
This is the confidence.py of lmfit adjusted for my needs.

Based on lmfit v0.7. for use - replace confidence.py with this script
(don't forget to remove confidence.pyc if you made changes)

Changes should be pushed to the original.

The original confidence.py is part of the lmfit package developed by:
   Copyright (c) 2011 Matthew Newville, The University of Chicago
   <newville@cars.uchicago.edu>

Changelog:

2013-06-14: added interface to fmin (nelder-mead).
######################################################################
