...
mv mos${M1_EV_PREFIX}-im5-400-1250.fits mos${M1_EV_PREFIX}-im5-400-1250-${analysis_id}.fits
...
mv mos${M1_EV_PREFIX}-5obj.pi mos${M1_EV_PREFIX}-5obj-${analysis_id}.pi
mv mos${M1_EV_PREFIX}-5ff.pi mos${M1_EV_PREFIX}-5ff-${analysis_id}.pi
mv mos${M1_EV_PREFIX}-im5-5000-7200.fits mos${M1_EV_PREFIX}-im5-5000-7200-${analysis_id}.fits
...
######################################################################
# preliminary outputs from combination and smoothing

mv comb-obj-im-400-1250.fits         comb-obj-im-400-1250-${analysis_id}.fits
mv comb-exp-im-400-1250.fits         comb-exp-im-400-1250-${analysis_id}.fits
mv comb-back-im-sky-400-1250.fits    comb-back-im-sky-400-1250-${analysis_id}.fits
mv comb-obj-im-2000-7200.fits        comb-obj-im-2000-7200-${analysis_id}.fits
mv comb-exp-im-2000-7200.fits        comb-exp-im-2000-7200-${analysis_id}.fits
mv comb-back-im-sky-2000-7200.fits   comb-back-im-sky-2000-7200-${analysis_id}.fits
mv adapt-400-1250.fits               adapt-400-1250-${analysis_id}.fits
