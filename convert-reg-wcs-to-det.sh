...
rm ${region_file}.pn-reg.txt
rm ${region_file}.m1-reg.txt
rm ${region_file}.m2-reg.txt
...
echo ${region_file}.pn-reg.txt
echo ${region_file}.m1-reg.txt
echo ${region_file}.m2-reg.txt
echo
